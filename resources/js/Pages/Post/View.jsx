                ...
                <div
                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <main className="mt-6">
                            ...
                            <small>{postData.user.name}</small> |
                            <small>{new Date(postData.created_at).toDateString()}</small>
                            <hr/>
                            <div>
                                {postData.desc}
                            </div>
                            <p>
                                <span>Like: {postData.likes} | Dislike: {postData.dislikes}</span>
                            </p>
                            <hr/>
                            <div className="mt-5">
                                <h3>Comments</h3>
                                {postData.comments.map(({
                                                            id, title, text, created_at, likes, dislikes, user
                                                        }) => (
                            ...
                            <div className="mt-5">
                                {auth.user ? (
                                    <form name="createForm" onSubmit={handleSubmit}>
                                        <div className="mb-0">
                                            <label className="">Send Comment</label>
                                            <textarea
                                                type="text"
